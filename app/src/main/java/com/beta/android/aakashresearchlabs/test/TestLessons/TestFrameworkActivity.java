...
import com.beta.android.aakashresearchlabs.test.TestSeries.Framework.l1F;
import com.beta.android.aakashresearchlabs.test.TestSeries.Framework.l2F;
...
public class TestFrameworkActivity extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list.add(new indexclass("Lesson 1",l1F.class));
        list.add(new indexclass("Lesson 2",l2F.class));
