...
import com.beta.android.aakashresearchlabs.test.TestSeries.Basic.l1B;
import com.beta.android.aakashresearchlabs.test.TestSeries.Basic.l2B;
...
public class TestBasicActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list.add(new indexclass("Lesson 1",l1B.class));
        list.add(new indexclass("Lesson 2",l2B.class));
