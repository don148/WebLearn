...
import com.beta.android.aakashresearchlabs.test.TestSeries.BackEnd.l1BE;
import com.beta.android.aakashresearchlabs.test.TestSeries.BackEnd.l2BE;
...
public class TestBackEndActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list.add(new indexclass("Lesson 1",l1BE.class));
        list.add(new indexclass("Lesson 2",l2BE.class));
