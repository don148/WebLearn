...
import com.beta.android.aakashresearchlabs.test.TestSeries.FrontEnd.l1FE;
import com.beta.android.aakashresearchlabs.test.TestSeries.FrontEnd.l2FE;
...
public class TestFrontEndActivity extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list.add(new indexclass("Lesson 1",l1FE.class));
        list.add(new indexclass("Lesson 2",l2FE.class));
